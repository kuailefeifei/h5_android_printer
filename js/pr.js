...
function searchDevices(address){
    ...
    var vlist2 = document.getElementById('list2'); // 注册容器用来显示配对设备
                ...
                if (BleDevice.getBondState() == bdevice.BOND_NONE) {
                    ...
                    if (address == BleDevice.getAddress()){
                        if (BleDevice.createBond()){ // 配对命令 createBond()
                            ...
                            li2.setAttribute('id', BleDevice.getAddress()); // 打印机 mac 地址
                            li2.setAttribute('onclick', 'print(id)'); // 注册 click 点击列表进行打印
                        ...
                        if (BleDevice.getName() != on) { //判断防止重复添加
                            ...
                            li1.setAttribute('id', BleDevice.getAddress()); // 打印机 mac 地址
                            li1.setAttribute('onclick', 'searchDevices(id)'); // 注册 click 点击列表进行配对
